 ...
 * 
 * Modified by : Mariswaran for Contient Trivia
 * Creation Data : June 2017 
 * 
 */

var APP_ID = "amzn1.ask.skill.398a737c-0697-41c2-b48f-40706a2929a6";
...
var continents = require("./lib/continents");
...
var languageString = {
    "en": {
        "translation": {
            ...
            "GAME_NAME" : "Continent Trivia", // Be sure to change this for your skill.
    ...
    "en-US": {
        "translation": {
            ...
            "GAME_NAME" : "Know Your Countries Continent Trivia Challenge" // Be sure to change this for your skill.
        }
    }
};
...
function loadQuestions(noOfQuestions)
{
    ...
    var totalCountries = 0;
        for(var ctryCtr=0; ctryCtr<4 ; ctryCtr++)
        {
            ...
            if(countries.countries[randomNumber].continent.length>1)
            {
    ...
    var continentText = "State the Continent of  " ;
    var answers = [];
    var contArr = ["AF", "AN", "AS", "EU" , "NA" , "OC", "SA"];

    
    answers.push(continents.continents[selectedCountries[0].continent]);
    arrayRemove(contArr,selectedCountries[0].continent)
    
    answers.push(continents.continents[contArr[0]]);
    arrayRemove(contArr,contArr[0])
    ...
    qanda[continentText + selectedCountries[0].name] = answers;
